...
export default {
  ...
  methods: {
    ...
    async getLabels(){
      await this.$store.dispatch("danhMucStore/get").then((res) => {
        if (res.resultCode === 'SUCCESS') {
          this.optionsLabels = res.data;
          return;
        }
        this.optionsLabels = [];
      });
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="mb-2">
                        ...
                        <textarea class="form-control" v-model="model.description" rows="4"   :class="{'is-invalid': submitted && $v.model.description.$error,}"></textarea>
                        <div
                    ...
                    <div class="col-md-12">
                      <div class="mb-2">
                        ...
                        <multiselect
                            ...
                            :class="{'is-invalid': submitted && $v.model.members.$error,}"
                        ></multiselect>
                        <div
                    ...
                    <div class="col-md-12">
                      <div class="mb-2">
                        ...
                        <multiselect
                            ...
                            selectLabel="Nhấn enter để chọn"
                            selectedLabel="Đã chọn"
                            :class="{'is-invalid': submitted && $v.model.groups.$error,}"
                        ></multiselect>
                        <div
                            v-if="submitted && !$v.model.groups.required"
                            class="invalid-feedback"
                        >
